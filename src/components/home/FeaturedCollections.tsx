...
const collections = [
  { id: "drops", name: "Drops", image: "/images/collection-drops.png", span: "col-span-1 md:col-span-2 row-span-2" },
  { id: "essence", name: "Essence", image: "/images/collection-essence.png", span: "col-span-1 row-span-1" },
  { id: "sparkles", name: "Sparkles", image: "/images/collection-sparkles.png", span: "col-span-1 row-span-1" },
  { id: "nexus", name: "Nexus", image: "/images/collection-nexus.png", span: "col-span-1 md:col-span-2 row-span-1" },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-16">
          <div className="flex items-center justify-center gap-4 mb-4">
            ...
            <span className="uppercase tracking-[0.2em] text-xs font-semibold">Discover</span>
            <div className="h-[1px] w-12 bg-black dark:bg-white opacity-30" />
          </div>
          <h2 className="font-serif text-4xl md:text-5xl">Our Collections</h2>
        </AnimatedSection>

        <div className="grid grid-cols-1 md:grid-cols-4 grid-rows-none md:grid-rows-3 gap-4 md:gap-6 md:h-[800px]">
          {collections.map((collection, index) => (
            ...
            >
              <Link href={`/collections/${collection.id}`} className="block w-full h-full min-h-[300px]">
