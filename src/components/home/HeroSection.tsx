    ...
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
        ...
        <div className="overflow-hidden mb-6">
          ...
          >
            Your <span className="italic font-light text-[var(--color-brand-accent)]">Sparkle</span><br />
            Within
          </motion.h1>
        </div>
        ...
        >
          Discover exceptional silver and panchadhatu pieces designed to capture moments, meticulously crafted to last lifetimes.
        </motion.p>
        ...
        >
          <Link href="/collections/all">
            <Button size="lg" className="bg-[var(--color-brand-accent)] text-black hover:bg-[#b09040]">
              Explore Collections
            </Button>
          </Link>
          <Link href="/bespoke">
